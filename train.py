...
Based on karpathy/autoresearch, cherry-picked and simplified from nanochat.
...
if __name__ == "__main__":
    ...
    # Save checkpoint for judge.py
    # torch.compile wraps the model — unwrap to get the original state_dict
    ...
    # Write metrics (val_bpb is null — judge.py fills it in)
    metrics = {
        "val_bpb": None,
    ...
    print(f"depth:            {DEPTH}")
    print("metrics.json written (run judge.py for val_bpb)")
