...
Usage (from repo root):
    modal run modal_remote/app.py                    # train + judge
    modal run modal_remote/app.py::prepare_data      # data prep only
"""
...
MODAL_DIR = REPO_ROOT / "modal_remote"
...
# Mount autoresearch/ source + judge_remote.py into /work
