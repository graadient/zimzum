"""
zimzum experiment database — stores every experiment (winners, losers, crashes).
Drop this into any autoresearch-compatible repo.
...
def record_experiment(conn, hypothesis, category, outcome, notes=None):
...
def main():
    ...
    if args.command == "record":
        row = record_experiment(conn, args.hypothesis, args.category, args.outcome, notes=args.notes)
